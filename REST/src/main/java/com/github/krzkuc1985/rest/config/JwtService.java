...
public class JwtService {
    ...
    private @Value("${jwt.secret-key}") String SECRET_KEY;
    private @Value("${jwt.issuer}") String ISSUER;
    private @Value("${jwt.access-token.expiration}") int ACCESS_TOKEN_EXPIRATION;
    private @Value("${jwt.refresh-token.expiration}") int REFRESH_TOKEN_EXPIRATION;
