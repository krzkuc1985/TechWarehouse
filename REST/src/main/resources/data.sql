...
VALUES
    ...
    (1, 'EDIT_ROLE', 'ROLE'),
    (1, 'DELETE_ROLE', 'ROLE'),
    (1, 'VIEW_ROLE_PERMISSION', 'ROLE'),
    (1, 'ADD_ROLE_PERMISSION', 'ROLE'),
    (1, 'DELETE_ROLE_PERMISSION', 'ROLE'),

    -- EMPLOYEE CONTROLLER
    (1, 'VIEW_EMPLOYEE', 'EMPLOYEE'),
    (1, 'ADD_EMPLOYEE', 'EMPLOYEE'),
    (1, 'EDIT_EMPLOYEE', 'EMPLOYEE'),
    (1, 'DELETE_EMPLOYEE', 'EMPLOYEE'),
    (1, 'VIEW_EMPLOYEE_ADDRESS', 'EMPLOYEE'),
    (1, 'EDIT_EMPLOYEE_ADDRESS', 'EMPLOYEE'),
    (1, 'EDIT_EMPLOYEE_LOGIN', 'EMPLOYEE'),
    (1, 'VIEW_EMPLOYEE_ROLE', 'EMPLOYEE'),
    (1, 'ADD_EMPLOYEE_ROLE', 'EMPLOYEE'),
    (1, 'DELETE_EMPLOYEE_ROLE', 'EMPLOYEE'),

    -- ITEM CATEGORY CONTROLLER
    (1, 'VIEW_ITEM_CATEGORY', 'ITEM_CATEGORY'),
    (1, 'ADD_ITEM_CATEGORY', 'ITEM_CATEGORY'),
    (1, 'EDIT_ITEM_CATEGORY', 'ITEM_CATEGORY'),
    (1, 'DELETE_ITEM_CATEGORY', 'ITEM_CATEGORY'),
    ...
    (1, 'EDIT_ITEM', 'ITEM'),
    (1, 'DELETE_ITEM', 'ITEM'),
    (1, 'VIEW_ITEM_WORK_ORDER', 'ITEM'),

    -- LOCATION CONTROLLER
    (1, 'VIEW_LOCATION', 'LOCATION'),
    (1, 'ADD_LOCATION', 'LOCATION'),
    (1, 'EDIT_LOCATION', 'LOCATION'),
    (1, 'DELETE_LOCATION', 'LOCATION'),

    -- WORK ORDER CONTROLLER
    (1, 'VIEW_WORK_ORDER', 'WORK_ORDER'),
    (1, 'ADD_WORK_ORDER', 'WORK_ORDER'),
    (1, 'EDIT_WORK_ORDER', 'WORK_ORDER'),
    (1, 'DELETE_WORK_ORDER', 'WORK_ORDER'),
    (1, 'VIEW_WORK_ORDER_ITEM', 'WORK_ORDER'),
    (1, 'ADD_WORK_ORDER_ITEM', 'WORK_ORDER'),

    -- WORK ORDER STATUS CONTROLLER
    (1, 'VIEW_WORK_ORDER_STATUS', 'WORK_ORDER_STATUS'),
    (1, 'ADD_WORK_ORDER_STATUS', 'WORK_ORDER_STATUS'),
    (1, 'EDIT_WORK_ORDER_STATUS', 'WORK_ORDER_STATUS'),
    (1, 'DELETE_WORK_ORDER_STATUS', 'WORK_ORDER_STATUS'),

    -- WORK ORDER TYPE CONTROLLER
    (1, 'VIEW_WORK_ORDER_TYPE', 'WORK_ORDER_TYPE'),
    (1, 'ADD_WORK_ORDER_TYPE', 'WORK_ORDER_TYPE'),
    (1, 'EDIT_WORK_ORDER_TYPE', 'WORK_ORDER_TYPE'),
    (1, 'DELETE_WORK_ORDER_TYPE', 'WORK_ORDER_TYPE');
