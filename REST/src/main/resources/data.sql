...
INSERT INTO item (version, name, order_number, description, quantity, measurement_unit_id, item_category_id, archive, max_quantity, min_quantity)
VALUES (1, 'Ball bearing 6204', '6204-ZZ-C3-SKF', 'Closed ball bearing, 20 mm diameter bearing', 15, 10, 1, false, 50, 5),
       (1, 'Pneumatic cylinder FESTO', 'DSNU-32-100-P-A', 'Pneumatic cylinder with 100 mm stroke, 32 mm diameter', 8, 10, 2, false, 20, 5),
       (1, 'Hydraulic pump Bosch Rexroth', '0510-356-928-231', 'Hydraulic pump with a capacity of 60 l/min, 230V power supply', 5, 10, 3, false, 10, 2),
       (1, 'Electromagnetic relay 12V', 'G2R-1-SN-12VDC-OMRON', 'Electromagnetic relay SPDT, control voltage 12V', 50, 10, 4, false, 100, 20),
       (1, 'Inverter Siemens SINAMICS', '6SL3210-1PE11-8UL0', 'Inverter for three-phase motors, 5 kW power', 3, 10, 5, true, 5, 1),
       (1, 'Inductive sensor IFM', 'IF5177-IFM', 'Inductive proximity sensor, 10 mm range', 25, 10, 5, false, 50, 10),
